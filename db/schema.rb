...
ActiveRecord::Schema.define(version: 20180814030351) do
  ...
  create_table "order_reports", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["order_id"], name: "index_order_reports_on_order_id", using: :btree
    t.index ["user_id"], name: "index_order_reports_on_user_id", using: :btree
  end
  ...
  add_foreign_key "order_reports", "orders"
  add_foreign_key "order_reports", "users"
